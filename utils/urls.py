...
urlpatterns = [
    ...
    path('users-matched-with-order/<int:order_id>/', views.SonyAccountByGameOrderView.as_view(),
         name='sony-account-by-order-games'),
    path('orders-matched-with-sony-users/<int:sony_account_id>/', views.GameOrdersBySonyAccountView.as_view(),
         name='sony-account-by-order-games'),
